...
class TagManagerSortOrder(StrEnum):
...
class TagAttributes(BaseModel):
    ...
    created_at: datetime | None = Field(None, description="Creation timestamp (read-only)")
    updated_at: datetime | None = Field(None, description="Last update timestamp (read-only)")
